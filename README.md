...
- Node.js: `22.17.0`
- Temporary production URL: <https://wisebrook.pages.dev>
- Planned custom domains: <https://wisebrook.org> and <https://www.wisebrook.org>

Cloudflare Pages should remain connected to the GitHub repository so every push to `main` starts a production build and deployment. Registrar nameserver delegation is still pending; attach the custom domains to the Pages project after the Cloudflare zone becomes active, then add only the exact DNS records required for the Pages hostname.
